...
# ขากลับ: ท่าตั้งต้น (S แล้ว C) หันตัวกลับให้อยู่แล้ว ขากลับจึงกด W เหมือนขาไป
...
# ภาพบริเวณหนึ่งต้องต่างไปกี่ % ถึงถือว่ามีอะไรเกิดขึ้น (ลากของสำเร็จ ฯลฯ)
REGION_CHANGE_MIN_PCT = 3.0
